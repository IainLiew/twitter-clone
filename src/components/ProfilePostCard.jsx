...
export default function ProfilePostCard({ post }) {
    ...
    const handlseCloseUpdateModal = () => setShowUpdateModal(false);
        ...
        <Row className="p-3" style={{ borderTop: "1px solid #D3D3D3", borderBottom: "1px solid #D3D3D3" }}>
            ...
            <Col>
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <UpdatePostModal
                        show={showUpdateModal} handleClose={handlseCloseUpdateModal} postId={postId} originalPostContent={content} />
                </div>
            </Col>
